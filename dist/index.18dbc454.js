...
class App {
    ...
    _skillsAnime() {
        ...
        (0, _gsapDefault.default).from(".skills--set-title--one", {
            y: "-100%",
            opacity: 0,
            duration: 1,
            ease: "sine",
        ...
        (0, _gsapDefault.default).from(".skills--set-title--two", {
            y: "-100%",
            opacity: 0,
            duration: 1,
            ease: "sine",
        ...
        (0, _gsapDefault.default).from(".skills--set-title--line--one", {
            x: "-100%",
            opacity: 0,
            duration: 1,
            ease: "sine",
        ...
        (0, _gsapDefault.default).from(".skills--set-title--line--two", {
            x: "100%",
            opacity: 0,
            duration: 1,
            ease: "sine",
        ...
        (0, _gsapDefault.default).from(".skills--set--list--one", {
            x: "-100%",
            opacity: 0,
            duration: 1,
            ease: "sine",
        ...
        (0, _gsapDefault.default).from(".skills--set--list--two", {
            x: "100%",
            opacity: 0,
            duration: 1,
            ease: "sine",
